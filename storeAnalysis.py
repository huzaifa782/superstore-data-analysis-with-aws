...
def process_and_upload_csv(
    ...
    bucket_name: str,
    date_column: str,
    s3_prefix: str = "order/snapshort_day=2017-01-01"
) -> None:
    """
    ...
    try:
        ...
        for date in unique_dates:
            ...
            # Define S3 key
            s3_key = f"{partition_folder}/orders_2017-01-01.csv"
...
def main():
    ...
    bucket_name = "store-analysis-ad-s3"
